...
=====================================================================================
 ...
 Stack : Streamlit + Google Gemini (google-generativeai) + gTTS
=====================================================================================
"""
...
def appeler_gemini(system_prompt: str, user_prompt: str) -> str:
    """Appelle l'API Google Gemini avec la clé globale configurée par l'administrateur."""
    import google.generativeai as genai

    cle_api = st.session_state.config_globale.get("gemini_api_key", "")
    if not cle_api:
        raise ValueError(
            "Aucune clé API Gemini n'est configurée pour le moment. "
...
st.markdown(
    ...
    <div class="frantsay-header">
        <p class="marque"><span class="accent">FRANTSAY</span></p>
...
if not st.session_state.config_globale.get("gemini_api_key"):
    if st.session_state.role_utilisateur == "admin":
        st.warning(
            "Aucune clé API Gemini n'est configurée. Ouvre l'onglet "
            "\"Configuration Admin\" pour l'enregistrer."
        )
    else:
        st.info(
            "La plateforme est en cours de configuration par l'administrateur. "
...
with onglet_correction:
    st.markdown(
        ...
        <div class="frantsay-card">
            ...
            <p style="color:#5a6472;">Écris une phrase ou un court texte en français.
...
with onglet_prononciation:
    st.markdown(
        ...
        <div class="frantsay-card">
            ...
            <p style="color:#5a6472;">Écoute la prononciation correcte des sons qui
    ...
    st.markdown(
        ...
        <div class="frantsay-card">
            ...
            <p style="color:#5a6472;">Tape une phrase, écoute-la prononcée
...
with onglet_pratique:
    st.markdown(
        ...
        <div class="frantsay-card">
            ...
            <p style="color:#5a6472;">Choisis une situation courante : un dialogue
    ...
    with onglet_admin:
        st.markdown(
            ...
            <div class="frantsay-card">
                ...
                <p style="color:#5a6472;">La clé API Gemini enregistrée ici est
...
#
# 3) Se connecter avec l'adresse admin@frantsay.mg (ou l'adresse définie dans
