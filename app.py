...
FRANTSAY_LOGO_SVG = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="48" height="48" style="vertical-align: middle; margin-right: 6px;">
  ...
  <!-- Structure du F et queue du Maki -->
  <path d="M 50 160 L 50 40 L 150 40 L 150 70 L 85 70 L 85 95 L 135 95 L 135 120 L 85 120 L 85 160 Z" fill="#FFFFFF"/>
  <path d="M 150 40 C 170 40, 180 60, 165 75 C 150 90, 130 70, 150 50" fill="none" stroke="#FFFFFF" stroke-width="12" stroke-linecap="round"/>
  <!-- Rayures de la queue -->
  <path d="M 158 43 L 164 49" stroke="#0A0E19" stroke-width="5"/>
  <path d="M 168 56 L 171 64" stroke="#0A0E19" stroke-width="5"/>
  <path d="M 163 71 L 156 74" stroke="#0A0E19" stroke-width="5"/>
</svg>"""
