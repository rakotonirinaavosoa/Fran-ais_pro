...
FRANTSAY_LOGO_SVG = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="100%" height="100%">
  <rect width="200" height="200" rx="48" fill="#0A0E19"/>
  <g transform="translate(0, 0)">
    <path d="M 100 40 C 70 40, 50 60, 50 90 Q 50 120, 100 120 Q 150 120, 150 90 C 150 60, 130 40, 100 40 Z" fill="#F8FAFC"/>
    <path d="M 100 95 L 100 125 C 100 135, 95 138, 90 138 C 85 138, 80 135, 80 125 Z" fill="#F8FAFC"/>
    <path d="M 100 95 L 100 125 C 100 135, 105 138, 110 138 C 115 138, 120 135, 120 125 Z" fill="#F8FAFC"/>
    <path d="M 100 95 C 100 85, 92 80, 85 80 C 78 80, 70 85, 70 95 Z" fill="#0A0E19"/>
    <path d="M 100 95 C 100 85, 108 80, 115 80 C 122 80, 130 85, 130 95 Z" fill="#0A0E19"/>
    <circle cx="85" cy="98" r="7" fill="#F59E0B"/>
    <circle cx="85" cy="98" r="3.5" fill="#0A0E19"/>
    <circle cx="115" cy="98" r="7" fill="#F59E0B"/>
    <circle cx="115" cy="98" r="3.5" fill="#0A0E19"/>
    <g transform="translate(148, 65)">
      <rect x="0" y="0" width="8" height="30" rx="4" fill="#F8FAFC"/>
      <rect x="15" y="5" width="8" height="20" rx="4" fill="#F8FAFC"/>
      <rect x="30" y="10" width="8" height="10" rx="4" fill="#F8FAFC"/>
      <rect x="-15" y="-5" width="8" height="40" rx="4" fill="#F8FAFC"/>
    </g>
    <path d="M 70 45 C 55 35, 45 60, 60 62 Z" fill="#F8FAFC"/>
  </g>
</svg>"""
...
if st.session_state.nav_page == "Accueil":
    ...
    st.markdown(f'''<section class="home-hero"><div class="home-hero-content"><h1 class="home-hero-brand"><span class="home-hero-logo">{FRANTSAY_LOGO_SVG}</span>RANTSAY</h1><p>Apprendre le français autrement</p><div class="home-hero-status">{status}</div></div><div class="daily-tip"><span class="bulb">💡</span><div><b>Conseil du jour</b><br><span>Lis une phrase à voix haute, puis réutilise-la dans une situation réelle. La régularité compte plus que la quantité.</span></div></div></section>''', unsafe_allow_html=True)
