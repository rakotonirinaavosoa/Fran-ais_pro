...
.stApp {
    background:
        linear-gradient(180deg, rgba(13, 34, 28, .48), rgba(38, 22, 14, .58)),
...
.stApp::after {
    ...
    position: fixed;
    inset: 0;
    background: linear-gradient(180deg, rgba(8,20,18,.10), rgba(8,20,18,.24));
    pointer-events: none;
    z-index: 0;
}
...
@media (prefers-color-scheme: dark) {
    ...
    .stApp {
        background:
            linear-gradient(180deg, rgba(5,18,14,.56), rgba(15,10,7,.66)),
            url("https://commons.wikimedia.org/wiki/Special:Redirect/file/The%20Avenue%20of%20the%20Baobabs%20in%20Madagascar%20near%20the%20city%20of%20Morondava%20at%20sunrise%20%2825%29.jpg")
            center / cover no-repeat fixed;
    }
    .auth-shell [data-testid="stWidgetLabel"] p,
