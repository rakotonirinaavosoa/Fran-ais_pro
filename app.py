...
.ton-espace-nav {
    ...
    box-shadow: 0 8px 24px rgba(var(--shadow-rgb),.07);
}
.ton-espace-label {
    font-size: .62rem;
    font-weight: 900;
...
def render_auth_screen() -> None:
    components.html(
        """<script>
        (function () {
            window.parent.document.body.classList.add("frantsay-welcome");
        })();
        </script>""",
        height=0,
    )
...
with st.sidebar:
    ...
    st.markdown(
        '<div class="sidebar-section-label">ESPACE CONNECTE</div>'
        '<div style="font-size:.72rem;color:#F7F4EC;line-height:1.5;">'
        'Navigation centralisee dans <b>Ton Espace</b>.<br>'
        'Niveau : ' + safe_html(st.session_state.level) +
        '</div>',
        unsafe_allow_html=True,
    )
...
with st.container(key="hero_box"):
    st.markdown(
        f"""<div class="frantsay-logo" aria-label="FRANTSAY">
            <div class="frantsay-logo-mark">F</div>
            <div>
                <div class="frantsay-logo-word">FRANTSAY</div>
                <div class="frantsay-logo-sub">APPRENDRE · PRATIQUER · PROGRESSER</div>
            </div>
        </div>
        <div class="dashboard-topline">
            <div>
                <div class="eyebrow"><span class="tag tag-solid">ACCUEIL</span> TON PARCOURS</div>
...
# =============================================================================
# BOUTON DASHBOARD — les 4 metriques restent masquees par defaut
# =============================================================================
...
# =============================================================================
# NAVIGATION UNIFIEE — routeur central "Ton Espace"
# =============================================================================
st.markdown(
    '<div class="ton-espace-nav"><div class="ton-espace-label">Ton Espace</div>',
    unsafe_allow_html=True,
)
...
if selected_page is not None and selected_page != st.session_state.nav_page:
