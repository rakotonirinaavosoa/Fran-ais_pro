...
with st.sidebar:
    st.markdown(
        ...
        '<div class="sidebar-logo-word">FRANTSAY</div></div>',
        unsafe_allow_html=True,
    )
...
if st.session_state.nav_page == "Accueil":
    # Page epuree et anonyme : aucun pseudo, aucune metrique de score ici.
    status = (
    ...
    st.markdown(
        f"""<div class="card">
            <span class="eyebrow"><span class="tag tag-solid">BIENVENUE</span></span>
            <h1 class="hero-title">Content de te revoir <span class="wave">*</span></h1>
            <p class="hero-sub">Reprends la ou tu en etais, a ton rythme.</p>
            <div style="margin-top:.6rem">{status}</div>
        </div>""",
        unsafe_allow_html=True,
    )
