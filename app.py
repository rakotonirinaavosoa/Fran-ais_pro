    ...
    if not supabase_ready():
        st.markdown(
            ...
            <div class="config-alert">
                ...
                <div>
                    <div class="config-alert-title">Service momentanement indisponible</div>
                    <div class="config-alert-sub">
                        L'espace personnel ne peut pas se connecter pour le moment.
        ...
        with st.expander("Diagnostic technique (administrateur)", expanded=False):
